...
properties= {@StaticServiceProperty(name="dataType", type="java.lang.String", value="org.etri.slice.commons.car.context.Pressure")})
@Instantiate
public class PressureSensor extends AbstractPulledSensor<Pressure> {
	...
	public void start() throws SliceException {
		super.start();
		s_logger.info("STARTED: " + PressureSensor.class.getSimpleName());			
	}
	...
	public void stop() throws SliceException {
		super.stop();
		s_logger.info("STOPPED: " + PressureSensor.class.getSimpleName());	
	}	

	@Override
	protected void publish(Pressure pressure) {
