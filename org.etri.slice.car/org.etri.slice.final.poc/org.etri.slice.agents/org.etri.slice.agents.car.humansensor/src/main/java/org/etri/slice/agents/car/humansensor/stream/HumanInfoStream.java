...
@Provides
@Instantiate(name=HumanInfoStream.SERVICE_NAME)
public class HumanInfoStream implements EventStream<HumanInfo> {

	public static final String SERVICE_NAME = "HumanInfoStream";
	
	@Override
	public TStream<HumanInfo> process(TStream<HumanInfo> stream) {
		return stream;
	}
