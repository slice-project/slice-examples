...
import org.etri.slice.agents.car.humansensor.stream.UserLeftStream;
...
@Component
@Instantiate
public class UserLeftChannel extends MqttEventPublisher<UserLeft> {

	private static final long serialVersionUID = -2285035484456774371L;
