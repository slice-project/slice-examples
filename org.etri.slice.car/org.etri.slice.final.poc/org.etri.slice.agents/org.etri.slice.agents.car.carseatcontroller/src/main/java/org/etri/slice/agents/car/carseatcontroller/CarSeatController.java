 ...
 */
package org.etri.slice.agents.car.carseatcontroller;
...
@Provides
@Instantiate
public class CarSeatController extends AbstractAgent implements Agent {
	
	@Property(name="groupId", value="org.etri.slice")
	public String groupId;
	
	@Property(name="artifactId", value="org.etri.slice.rules.car.carseatcontroller")
