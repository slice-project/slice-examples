 ...
 */
package org.etri.slice.agents.car.wipercontroller;
...
@Provides
@Instantiate
public class WiperController extends AbstractAgent implements Agent {
	
	@Property(name="groupId", value="org.etri.slice")
	public String groupId;
	
	@Property(name="artifactId", value="org.etri.slice.rules.car.wipercontroller")
