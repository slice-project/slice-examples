...
@Provides
//@Instantiate
public class SeatPostureSensorX extends AbstractPollingSensor<SeatPosture> {
	
	private static Logger s_logger = LoggerFactory.getLogger(SeatPostureSensorX.class);
	...
	public void start() throws SliceException {
		...
		super.start();		
		s_logger.info("STARTED: " + SeatPostureSensorX.class.getSimpleName());			
	}
	...
	public void stop() throws SliceException {
		super.stop();
		s_logger.info("STOPPED: " + SeatPostureSensorX.class.getSimpleName());	
	}	
