...
@Instantiate
public class WiperControlCommandAdaptor extends AbstractMqttSubscriber<MqttCommand> {
	
	private static final long serialVersionUID = -5598084805488432870L;
	private static Logger s_logger = LoggerFactory.getLogger(WiperControlCommandAdaptor.class);		

	@Property(name="topic", value="d/WiperControl")
	...
	private MqttCommandInvoker<WiperControl> m_invoker;
	...
	public void start(){
		...
		try {
			m_invoker = new MqttCommandInvoker<WiperControl>(WiperControl.class, m_port);
		} 
		catch (Throwable e) {
			s_logger.error("ERR : " + e.getMessage());
		}		
		s_logger.info("STARTED: " + WiperControlCommandAdaptor.class.getSimpleName());			
	}
	...
	public void stop() {
		super.stop();
		s_logger.info("STOPPED: " + WiperControlCommandAdaptor.class.getSimpleName());	
	}		
