...
@Provides(specifications= {DataListener.class}, 
	properties= {@StaticServiceProperty(name="dataType", type="java.lang.String", value="org.etri.slice.commons.car.context.BodyPartLength")})
@Instantiate
public class BodyPartLengthSensor extends AbstractPulledSensor<BodyPartLength> {
	...
	public void start() throws SliceException {
		super.start();
		s_logger.info("STARTED: " + BodyPartLengthSensor.class.getSimpleName());			
	}
	...
	public void stop() throws SliceException {
		super.stop();
		s_logger.info("STOPPED: " + BodyPartLengthSensor.class.getSimpleName());	
	}	

	@Override
	protected void publish(BodyPartLength bodylength) {
