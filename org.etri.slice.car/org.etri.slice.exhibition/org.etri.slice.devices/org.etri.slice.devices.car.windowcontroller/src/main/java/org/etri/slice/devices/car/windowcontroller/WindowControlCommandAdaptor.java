...
@Instantiate
public class WindowControlCommandAdaptor extends AbstractMqttSubscriber<MqttCommand> {
	
	private static final long serialVersionUID = -7108597835039326910L;
	private static Logger s_logger = LoggerFactory.getLogger(WindowControlCommandAdaptor.class);		

	@Property(name="topic", value="d/WindowControl")
	...
	private MqttCommandInvoker<WindowControl> m_invoker;
	...
	public void start(){
		...
		try {
			m_invoker = new MqttCommandInvoker<WindowControl>(WindowControl.class, m_port);
		} 
		catch (Throwable e) {
			s_logger.error("ERR : " + e.getMessage());
		}		
		s_logger.info("STARTED: " + WindowControlCommandAdaptor.class.getSimpleName());			
	}
	...
	public void stop() {
		super.stop();
		s_logger.info("STOPPED: " + WindowControlCommandAdaptor.class.getSimpleName());	
	}		
