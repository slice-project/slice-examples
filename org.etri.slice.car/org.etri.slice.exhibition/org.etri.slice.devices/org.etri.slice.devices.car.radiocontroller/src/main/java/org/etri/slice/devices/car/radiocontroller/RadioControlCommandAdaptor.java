...
@Instantiate
public class RadioControlCommandAdaptor extends AbstractMqttSubscriber<MqttCommand> {
	
	private static final long serialVersionUID = 1127793363116648488L;
	private static Logger s_logger = LoggerFactory.getLogger(RadioControlCommandAdaptor.class);		

	@Property(name="topic", value="d/RadioControl")
	...
	private MqttCommandInvoker<RadioControl> m_invoker;
	...
	public void start(){
		...
		try {
			m_invoker = new MqttCommandInvoker<RadioControl>(RadioControl.class, m_port);
		} 
		catch (Throwable e) {
			s_logger.error("ERR : " + e.getMessage());
		}		
		s_logger.info("STARTED: " + RadioControlCommandAdaptor.class.getSimpleName());			
	}
	...
	public void stop() {
		super.stop();
		s_logger.info("STOPPED: " + RadioControlCommandAdaptor.class.getSimpleName());	
	}		
