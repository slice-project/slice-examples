...
@Instantiate
public class MirrorControlCommandAdaptor extends AbstractMqttSubscriber<MqttCommand> {
	...
	private MqttCommandInvoker<MirrorControl> m_invoker;
	...
	public void start(){
		...
		try {
			m_invoker = new MqttCommandInvoker<MirrorControl>(MirrorControl.class, m_port);
		} 
		catch (Throwable e) {
			s_logger.error("ERR : " + e.getMessage());
		}		
		s_logger.info("STARTED: " + MirrorControlCommandAdaptor.class.getSimpleName());			
	}
	...
	public void stop() {
		super.stop();
		s_logger.info("STOPPED: " + MirrorControlCommandAdaptor.class.getSimpleName());	
	}		
