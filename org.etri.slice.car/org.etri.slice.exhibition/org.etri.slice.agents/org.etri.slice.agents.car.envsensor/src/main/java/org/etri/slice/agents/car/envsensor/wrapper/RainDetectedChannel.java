...
import org.etri.slice.agents.car.envsensor.stream.RainDetectedStream;
import org.etri.slice.commons.car.event.RainDetected;

@Component
@Instantiate
public class RainDetectedChannel extends MqttEventPublisher<RainDetected> {

	private static final long serialVersionUID = -4500617760354385875L;
