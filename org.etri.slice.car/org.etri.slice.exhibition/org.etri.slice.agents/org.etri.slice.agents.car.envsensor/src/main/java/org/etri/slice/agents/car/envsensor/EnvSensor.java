 ...
 */
package org.etri.slice.agents.car.envsensor;
...
@Provides
@Instantiate
public class EnvSensor extends AbstractAgent implements Agent {
	
	@Property(name="groupId", value="org.etri.slice")
	public String groupId;
	
	@Property(name="artifactId", value="org.etri.slice.rules.car.envsensor")
