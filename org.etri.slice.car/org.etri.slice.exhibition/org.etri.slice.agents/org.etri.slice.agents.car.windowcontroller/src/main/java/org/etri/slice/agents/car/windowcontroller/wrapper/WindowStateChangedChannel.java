...
import org.etri.slice.agents.car.windowcontroller.stream.WindowStateChangedStream;
import org.etri.slice.commons.car.event.WindowStateChanged;

@Component
@Instantiate
public class WindowStateChangedChannel extends MqttEventPublisher<WindowStateChanged> {

	private static final long serialVersionUID = -7982101463982980708L;

	@Property(name="topic", value=WindowStateChanged.TOPIC)
	...
	@Requires(from=WindowStateChangedStream.SERVICE_NAME)
	private EventStream<WindowStateChanged> m_streaming;		
	...
	protected EventStream<WindowStateChanged> getEventStream() {
		return m_streaming;
	}	
