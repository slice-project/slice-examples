...
@Provides
@Instantiate(name=WiperStateChangedStream.SERVICE_NAME)
public class WiperStateChangedStream implements EventStream<WiperStateChanged> {

	public static final String SERVICE_NAME = "WiperStateChangedStream";
	
	@Override
	public TStream<WiperStateChanged> process(TStream<WiperStateChanged> stream) {
		return stream;
	}
