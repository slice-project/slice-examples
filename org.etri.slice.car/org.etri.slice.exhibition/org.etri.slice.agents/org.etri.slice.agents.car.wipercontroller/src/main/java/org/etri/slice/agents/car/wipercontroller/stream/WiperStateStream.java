...
@Provides
@Instantiate(name=WiperStateStream.SERVICE_NAME)
public class WiperStateStream implements EventStream<WiperState> {

	public static final String SERVICE_NAME = "WiperStateStream";
	
	@Override
	public TStream<WiperState> process(TStream<WiperState> stream) {
		return stream;
	}
