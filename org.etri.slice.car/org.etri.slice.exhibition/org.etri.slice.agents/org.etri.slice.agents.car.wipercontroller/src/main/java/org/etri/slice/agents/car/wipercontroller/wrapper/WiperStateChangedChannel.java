...
import org.etri.slice.agents.car.wipercontroller.stream.WiperStateChangedStream;
import org.etri.slice.commons.car.event.WiperStateChanged;

@Component
@Instantiate
public class WiperStateChangedChannel extends MqttEventPublisher<WiperStateChanged> {

	private static final long serialVersionUID = -8169224500701019122L;

	@Property(name="topic", value=WiperStateChanged.TOPIC)
	...
	@Requires(from=WiperStateChangedStream.SERVICE_NAME)
	private EventStream<WiperStateChanged> m_streaming;		
	...
	protected EventStream<WiperStateChanged> getEventStream() {
		return m_streaming;
	}	
