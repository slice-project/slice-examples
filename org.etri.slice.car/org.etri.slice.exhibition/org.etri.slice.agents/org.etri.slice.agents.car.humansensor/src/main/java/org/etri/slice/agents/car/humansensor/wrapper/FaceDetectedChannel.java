...
import org.etri.slice.agents.car.humansensor.stream.FaceDetectedStream;
import org.etri.slice.commons.car.event.FaceDetected;

@Component
@Instantiate
public class FaceDetectedChannel extends MqttEventPublisher<FaceDetected> {

	private static final long serialVersionUID = 7099581548945623081L;
