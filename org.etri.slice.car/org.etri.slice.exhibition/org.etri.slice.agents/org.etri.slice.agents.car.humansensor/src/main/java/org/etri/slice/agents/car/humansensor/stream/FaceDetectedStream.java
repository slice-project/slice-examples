...
@Provides
@Instantiate(name=FaceDetectedStream.SERVICE_NAME)
public class FaceDetectedStream implements EventStream<FaceDetected> {

	public static final String SERVICE_NAME = "FaceDetectedStream";
	
	@Override
	public TStream<FaceDetected> process(TStream<FaceDetected> stream) {
		return stream;
	}
