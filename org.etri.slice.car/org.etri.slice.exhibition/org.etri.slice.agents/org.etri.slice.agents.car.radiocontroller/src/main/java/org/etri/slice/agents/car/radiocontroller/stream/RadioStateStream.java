...
@Provides
@Instantiate(name=RadioStateStream.SERVICE_NAME)
public class RadioStateStream implements EventStream<RadioState> {

	public static final String SERVICE_NAME = "RadioStateStream";
	
	@Override
	public TStream<RadioState> process(TStream<RadioState> stream) {
		return stream;
	}
