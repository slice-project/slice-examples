...
import org.etri.slice.agents.car.radiocontroller.stream.RadioStateChangedStream;
import org.etri.slice.commons.car.event.RadioStateChanged;

@Component
@Instantiate
public class RadioStateChangedChannel extends MqttEventPublisher<RadioStateChanged> {

	private static final long serialVersionUID = 2751521952647302296L;

	@Property(name="topic", value=RadioStateChanged.TOPIC)
	...
	@Requires(from=RadioStateChangedStream.SERVICE_NAME)
	private EventStream<RadioStateChanged> m_streaming;		
	...
	protected EventStream<RadioStateChanged> getEventStream() {
		return m_streaming;
	}	
