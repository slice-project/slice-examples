...
@Provides
@Instantiate(name=RadioStateChangedStream.SERVICE_NAME)
public class RadioStateChangedStream implements EventStream<RadioStateChanged> {

	public static final String SERVICE_NAME = "RadioStateChangedStream";
	
	@Override
	public TStream<RadioStateChanged> process(TStream<RadioStateChanged> stream) {
		return stream;
	}
