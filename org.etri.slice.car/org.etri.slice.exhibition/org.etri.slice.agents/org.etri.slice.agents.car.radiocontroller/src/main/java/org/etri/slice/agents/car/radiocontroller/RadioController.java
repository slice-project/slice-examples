 ...
 */
package org.etri.slice.agents.car.radiocontroller;
...
@Provides
@Instantiate
public class RadioController extends AbstractAgent implements Agent {
	
	@Property(name="groupId", value="org.etri.slice")
	public String groupId;
	
	@Property(name="artifactId", value="org.etri.slice.rules.car.radiocontroller")
