 ...
 */
package org.etri.slice.agents.room.temperaturedetector;
...
@Provides
@Instantiate
public class TemperatureDetector extends AbstractAgent implements Agent {
	
	@Property(name="groupId", value="org.etri.slice")
	public String groupId;
	
	@Property(name="artifactId", value="org.etri.slice.rules.room.temperaturedetector")
